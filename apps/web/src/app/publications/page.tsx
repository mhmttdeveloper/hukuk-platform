    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Yayınlar yükleniyor...</p>
        </div>
      </div>
    )
  }
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-8 transition-colors duration-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div key={publication.id} className="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden hover:shadow-lg transition-shadow duration-200 border border-gray-200 dark:border-gray-700 transition-colors">
              <div className="p-6">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-sm text-gray-500">{publication.readTime} dk okuma</span>
                </div>
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <Advertisement position="sidebar-top" />
          
          {/* Sidebar Bottom Advertisement */}
          <Advertisement position="sidebar-bottom" />
        </div>
      </div>
